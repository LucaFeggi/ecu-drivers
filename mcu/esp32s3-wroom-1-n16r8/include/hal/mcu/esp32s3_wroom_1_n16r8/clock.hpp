...
// Peripheral clocks and resets are deliberately owned by the board/startup
// layer. A driver never silently changes another peripheral's clock state.
...
class Gate {
 public:
  ...
  void enable(resource selected) noexcept {
    switch (selected) {
      case resource::uart0:
        system_->perip_clk_en0.uart_clk_en = 1U;
        break;
      case resource::uart1:
        system_->perip_clk_en0.uart1_clk_en = 1U;
        break;
      case resource::uart2:
        system_->perip_clk_en1.uart2_clk_en = 1U;
        break;
      case resource::i2c0:
        system_->perip_clk_en0.i2c_ext0_clk_en = 1U;
        break;
      case resource::i2c1:
        system_->perip_clk_en0.i2c_ext1_clk_en = 1U;
        break;
      case resource::spi2:
        system_->perip_clk_en0.spi2_clk_en = 1U;
        break;
      case resource::spi3:
        system_->perip_clk_en0.spi3_clk_en = 1U;
        break;
      case resource::spi2_dma:
        system_->perip_clk_en0.spi2_dma_clk_en = 1U;
        break;
      case resource::spi3_dma:
        system_->perip_clk_en0.spi3_dma_clk_en = 1U;
        break;
      case resource::gdma:
        system_->perip_clk_en1.dma_clk_en = 1U;
        break;
      case resource::twai:
        system_->perip_clk_en0.can_clk_en = 1U;
        break;
      case resource::ledc:
        system_->perip_clk_en0.ledc_clk_en = 1U;
        break;
      case resource::systimer:
        system_->perip_clk_en0.systimer_clk_en = 1U;
        break;
      case resource::adc:
        ...
        break;
      case resource::sdmmc:
        system_->perip_clk_en1.sdio_host_clk_en = 1U;
        break;
      ...
      case resource::spi_mem:
        system_->perip_clk_en0.spi01_clk_en = 1U;
        break;
    }
  }
