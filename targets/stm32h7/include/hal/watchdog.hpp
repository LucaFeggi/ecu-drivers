...
namespace hal::stm32h7::watchdog {
...
class error {
public:
  explicit constexpr error(hal::watchdog::error_kind kind) noexcept : kind_{kind} {}
...
public:
  ...
  explicit Feeder(Registers &registers, poll_budget timeout = {100'000U}) noexcept
